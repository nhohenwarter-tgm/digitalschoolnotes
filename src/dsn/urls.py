...
urlpatterns = [
    ...
    url(r'^api/timetable/add', 'dsn.views.management_views.view_add_timetable', name="add_timetable"),
    ...
    url(r'^api/getothercollaborators', 'dsn.views.management_views.view_CollaboratorsProfile', name="getothercollaborators"),
    ...
    url(r'^api/notebook_activeby', 'dsn.views.management_views.view_get_is_active_by', name="notebookactiveby"),
    ...
    url(r'^api/remove_notebook_collaborator', 'dsn.views.management_views.view_removeCollaborator', name="removeCollaborator"),
    ...
    url(r'^api/userdata_edit', 'dsn.views.management_views.view_editUserData', name="setUser"),
    url(r'^api/password_edit', 'dsn.views.management_views.view_editUserPassword', name="setPassword"),
