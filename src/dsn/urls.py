...
urlpatterns = [
    ...
    url(r'^api/admin_user_search', 'dsn.views.administration_views.view_searchUser', name="admin_user_search"),
    ...
    url(r'^api/notebooks_edit', 'dsn.views.management_views.view_editNotebook', name="editNotebook"),
