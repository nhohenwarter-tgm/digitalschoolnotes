...
\insertpicture{images/ocr/ocrbsp.png}{Beispiel einer Texterkennung \cite{OCRBSP}}{\cite{OCRBSP}}{itm:ocrbsp}{1.0}
...
\insertpicture{images/ocr/bitmuster.jpg}{Bitmustervergleich \cite{OCRB}}{\cite{OCRB}}{itm:bitm}{1.0}
...
\insertpicture{images/ocr/klassi.jpg}{Klassenbaum für Merkmalsanalyse \cite{OCRB}}{\cite{OCRB}}{itm:klassi}{1.0}
...
\insertpicture{images/ocr/vektor.jpg}{Vektorisierung eines Zeichens \cite{OCRB}}{\cite{OCRB}}{itm:vektor}{1.0}
...
\insertpicture{images/ocr/fresh.jpg}{Beispielbild für OCR-Analyse (selfmade)}{(selfmade)}{itm:fresh}{1.0}
...
\insertpicture{images/ocr/bu.png}{OCR-Button (selfmade)}{(selfmade)}{itm:but}{1.0}

Darauf öffnet sich ein Dialog mit einem Dateieingabefeld:

\insertpicture{images/ocr/di.png}{OCR-Dialog (selfmade)}{(selfmade)}{itm:di}{1.0}
...
\insertpicture{images/ocr/bspbild.jpg}{Beispielbild für OCR-Analyse (selfmade)}{(selfmade)}{itm:bsp}{0.55}

\insertpicture{images/ocr/bsptext.png}{Erzeugtes Textelement (selfmade)}{(selfmade)}{itm:text}{0.35}
