...
\insertpicture{images/usermanagement/Registrierung}{Registrierung bei DSN}{(selfmade)}{itm:authentisierung-chart}{0.20}

\newpage

Ein \gls{CAPTCHA} soll bei der Registrierung verhindern, dass eine Software oder ein Bot einen Account erzeugt.\\
