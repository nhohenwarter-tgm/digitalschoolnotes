...
\insertpicture{images/Projektkoordination/vmodell.png}{Phasen des klassischen V-Modells\cite{VMODELL}}{\cite{VMODELL}}{itm:vmod}{1.0}
...
\insertpicture{images/Projektkoordination/unterschiede.png}{Klassisches PM vs. Agiles PM \cite{UNT}}{\cite{UNT}}{itm:unters}{1.0}
...
\insertpicture{images/Projektkoordination/burndownErk.png}{Beispiel eines Sprint-Burndown-Charts \cite{BURNERK}}{\cite{BURNERK}}{itm:burnerk}{1.0}
...
\insertpicture{images/Projektkoordination/scrumablauf.png}{Scrum-Ablauf \cite{SCRUMABL}}{\cite{SCRUMABL}}{itm:scrumabl}{1.0}
...
\insertpicture{images/Projektkoordination/userst.png}{Beispiel für eine User Story in OnTime (selfmade)}{(selfmade)}{itm:userst}{1.0}
...
\insertpicture{images/Projektkoordination/pomodoro.png}{Ansicht eines Pomodoro-Timers (selfmade)}{(selfmade)}{itm:pomo}{1.0}
...
\insertpicture{images/Projektkoordination/sprint0.png}{Burndown-Chart des Evaluierungssprints (selfmade)}{(selfmade)}{itm:bur}{1.0}
...
\insertpicture{images/Projektkoordination/sprint1.png}{Burndown-Chart des ersten Sprints (selfmade)}{(selfmade)}{itm:bur}{1.0}
...
\insertpicture{images/Projektkoordination/sprint2.png}{Burndown-Chart des zweiten Sprints (selfmade)}{(selfmade)}{itm:bur}{1.0}
...
\insertpicture{images/Projektkoordination/sprint3.png}{Burndown-Chart des dritten Sprints (selfmade)}{(selfmade)}{itm:bur}{1.0}
...
\insertpicture{images/Projektkoordination/sprint4.png}{Burndown-Chart des vierten Sprints (selfmade)}{(selfmade)}{itm:bur}{1.0}
...
\insertpicture{images/Projektkoordination/sprint5.png}{Burndown-Chart des letzten Sprints (selfmade)}{(selfmade)}{itm:bur}{1.0}
