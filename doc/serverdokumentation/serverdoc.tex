...
\tabhvent{\textbf{Geprüft}} & \tabhvent{04.11.2015} & \tabhvent{Selina Brinnich} &  \tabhvent{}            \\ \hline
...
\tabhvent{\textbf{3.0}} & \tabhvent{04.11.2015} & \tabhvent{QA} &  \tabhvent{Brinnich}    &  \tabhvent{Rechtschreibfehler}         \\ \hline
\end{tabularx}
\end{table}
\newpage
