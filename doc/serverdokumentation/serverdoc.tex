...
\textbf{{\color{g4}Version 3.0 \hfill 04.11.2015 \hfill Status: [RELEASE]}}
%Table
\begin{table}[h]
...
\tabhvent{\textbf{Geprüft}} & \tabhvent{04.11.2015} & \tabhvent{Thomas Stedronsky} &  \tabhvent{}            \\ \hline
...
\tabhvent{\textbf{1.2}} & \tabhvent{12.10.2015} & \tabhvent{Bearbeitet} &  \tabhvent{Hohenwarter}    &  \tabhvent{Deployment}         \\ \hline
\tabhvent{\textbf{2.0}} & \tabhvent{14.10.2015} & \tabhvent{QA} &  \tabhvent{Stedronsky}    &  \tabhvent{Rechtschreibfehler}         \\ \hline
\tabhvent{\textbf{2.1}} & \tabhvent{14.10.2015} & \tabhvent{Bearbeitet} &  \tabhvent{Hohenwarter}    &  \tabhvent{uWsgi}         \\ \hline
\tabhvent{\textbf{3.0}} & \tabhvent{04.11.2015} & \tabhvent{QA} &  \tabhvent{Stedronsky}    &  \tabhvent{Rechtschreibfehler}         \\ \hline
\end{tabularx}
\end{table}
\newpage
